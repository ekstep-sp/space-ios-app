...
//                   Singleton.universalLink = Singleton.appConfigConstants.appUrl + "/training"
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        let dictionary = NSDictionary(object: "Mozilla/5.0 (iPad; CPU OS 9_1 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Version/9.0 Mobile/13B14 3 Safari/601.1", forKey: "UserAgent" as NSCopying)
        ...
        WiFiUtil.netConnectionCheck(){
            ...
            if isConnected == true{
                ...
                WiFiUtil.openRapSuccess() {
                    isConnected in
                    print("SPace Connection:",isConnected)
                    if isConnected == true {
